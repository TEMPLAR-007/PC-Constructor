            ...
            <div dashboard-sidebar className="hero-content flex-col lg:flex-row-reverse" >
                ...
                <div dashboard-sidebar className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-200 " >
                    <div dashboard-sidebar className="card-body" >
                        <h1 dashboard-sidebar className="text-5xl font-bold mb-6 text-secondary" > Sign Up now!</h1 >
                        <form onSubmit={handleSubmit(onSubmit)}>

                            <div dashboard-sidebar className="form-control mb-3">
                                <label dashboard-sidebar className="label">
                                    <span dashboard-sidebar className="label-text">Name</span>
                                </label >
                                <input
                                    type="text"
                                    placeholder="Name"
                            ...
                            <div dashboard-sidebar className="form-control" >
                                ...
                                <p> Already have an account? <Link dashboard-sidebar className='text-primary' to="/login"> Please Login</Link></p >
                            </div >

                            <input dashboard-sidebar className="w-full max-w-xs mt-6 btn btn-primary" type="submit" value="Sign Up" />
